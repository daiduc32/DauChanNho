...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row">
            <div class="col-md-6">
                <img class="card-img-top mb-5 mb-md-0" style="max-width: 350px" loading="lazy" id="display-img" src="<?php echo validate_image($img) ?>" alt="..." />
            ...
            <div class="col-md-6">
                <h5 class="display-9 fw-bolder"><?php echo $product_name ?></h5>
                <div class="fs-5 mb-2">
                 <span class="text-danger text-bold" id="price"><?php echo $inv[0]['price'] ?></span>
                <br>
                <p style="font-size:12px; color: gray; opacity: 0.5;"><i>Số lượng : <span id="avail"><?php echo $inv[0]['quantity'] ?></span> </i></p>
                </div>
                <div class="fs-5 mb-3 d-flex justify-content-start">
                ...
                <div class="d-flex">
                    <input class="text-danger text-bold"    type="hidden" name="price" value="<?php echo $inv[0]['price'] ?>">
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Có thể bạn cũng thích?</h2>
