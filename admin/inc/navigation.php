...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <span class="brand-text font-weight-light text-center ml-3">Danh sách</span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=users/action" class="nav-link nav-product">
                        <i class="nav-icon fas fa-box"></i>
                        <p>
                          Quản lý Clients
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=blog/index" class="nav-link nav-product">
                        <i class="nav-icon fas fa-box"></i>
                        <p>
                          Quản lý bài viết
                        </p>
