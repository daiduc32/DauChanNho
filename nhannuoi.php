        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Trang chủ |<i class="ion-ios-arrow-forward"></i></a></span> <span>Nhận nuôi thú cưng <i class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-0 bread">Danh sách thú cưng</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ftco-section bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                $result = mysqli_query($conn, "SELECT * FROM adopt_pet ORDER BY pet_id DESC LIMIT $start_from, $records_per_page; ");
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        //
                        $sql = "SELECT COUNT(pet_id) AS total FROM adopt_pet";
                        ...
                        <div class="col-md-6 col-lg-3 ftco-animate">
                            <div class="staff">
                                <div class="img-wrap d-flex align-items-stretch">
                                    <div class="img align-self-stretch" style="background-image: url(uploads/adopt_pet/<?php echo $img_url; ?>);"></div>
                                </div>
                                <div class="text pt-3 px-3 pb-4 text-center">
                                    <h3><?php echo $ten; ?></h3>
                                    <div class="faded">

                                        <p><b>Giống :</b> <?php echo $giongloai; ?></p>
                                        <p><b>Giới tính :</b> <?php echo $gioitinh; ?></p>
                                    </div>
                                    <a class="self-center pt-2" href="view_thucung.php?uid=<?php echo $pet_id; ?>">
                                    <button type="button" class="btn btn-outline-danger mr-md-3 py-3 px-4"><b>Xem thêm</b></button></a>
                                </div>
                            </div>
                        </div>    
                    ...
                    <div class="block-27">
                        <ul>
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                echo "<li><a href='nhannuoi.php?page=" . $i . "'>" . $i . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
